...
2. Name of the second table (always plural): `posts` 
    ...
    Column names: `posts`, 'content', 'views',
...
-> Therefore,
-> An artist/user HAS MANY albums/posts
-> An album/post BELONGS TO an artist/user

-> Therefore, the foreign key is on the albums/post table.
```
